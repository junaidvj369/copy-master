$(document).ready(function () {
    ...
    function AjaxAdminListTable() {
        ...
        if ($.fn.DataTable.isDataTable("#chapter_table")) {
            $("#chapter_table").DataTable().destroy();
        }

        table = $("#chapter_table").DataTable({
            bProcessing: true,
            serverSide: true,
            pageLength: 10,
            paging: true,
            ...
            ajax: {
                url: $("#chapter_table").data("route"), // json datasource
    ...
    $(document).on("click", ".delete_chapter", function (event) {
